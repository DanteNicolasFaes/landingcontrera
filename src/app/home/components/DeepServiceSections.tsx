...
const sections: ServiceDeepSection[] = [
{
  ...
  cases: ['Divorcio vincular de presentación conjunta o unilateral', 'Cuota alimentaria: fijación, aumento y ejecución', 'Régimen de comunicación con hijos', 'Responsabilidad parental y acuerdos de crianza', 'Violencia familiar: medidas cautelares y protección'],
...
},
{
  ...
  cases: ['Despido sin causa y liquidación incorrecta', 'Indemnizaciones adeudadas o mal calculadas', 'Diferencias salariales', 'Acuerdos ante el Ministerio de Trabajo', 'Reclamos ante el Ministerio de Trabajo'],
