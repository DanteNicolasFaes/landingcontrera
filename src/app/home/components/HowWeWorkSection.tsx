...
export default function HowWeWorkSection() {
  ...
  return (
    <section id="como-trabajamos" ref={ref} className="py-24 md:py-32 bg-[#0F1923] border-t border-white/[0.06]" aria-labelledby="how-title">
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div className="reveal">
            ...
            <h2 id="how-title" className="section-title font-serif text-white">
              Tres pasos para<br />
              <span className="italic font-light text-white/50">resolver tu caso.</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-14">
          {steps?.map((step, i) => (
            ...
            >
              ...
              <p className="text-[14px] text-[#5A6475] leading-relaxed">{step?.desc}</p>
        ...
        <div className="reveal reveal-delay-4 text-center">
          <a
            ...
            className="inline-flex items-center gap-3 bg-[#C8A96E] hover:bg-[#D9BE8A] text-[#0F1923] font-semibold text-[13px] uppercase tracking-widest px-10 py-4 rounded-sm transition-all duration-300 hover:-translate-y-0.5 shadow-gold"
          >
